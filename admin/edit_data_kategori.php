    ...
    <div id="app"> 
        ...
        <div id="kategori-page" v-show="page.name == 'kategori-page'">
            ...
            <div id="tab-kategori" class="black white-text" style="margin:5px;padding:15px">
                <h4 class="center"><b><br>Edit Kategori</b></h4><br>
                <div class="input-field">
                    <input id="nama" type="text" class="validate black white-text" placeholder="nama" v-model="kategori.nama">
                    <label for="nama">
                        <span>Nama</span>
                    </label>
                </div>
                <div class="input-field">
                    <input id="deskripsi" type="text" class="validate black white-text" placeholder="deskripsi" v-model="kategori.deskripsi">
                    <label for="deskripsi">
                        <span>Deskripsi</span>
                    </label>
                </div> 
                <div class="input-field">
                    <input id="url" type="text" class="validate black white-text" placeholder="url" v-model="kategori.url_gambar">
                    <label for="url">
                        <span>Url Gambar</span>
                    </label>
                </div>       
                <br />
                <a @click="updateKategori" class="center waves-effect waves-light btn-large orange white-text" style="text-transform:none;width:100%;">
                    <b>
                        <span>Update</span>
                    </b>    
                </a>
        ...
        new Vue({
            ...
            methods : {
                ...
                getKategori(){
                    ...
                    axios
                        .post(this.baseUrl() + '/api/kategori/one.php',this.kategori)
                        .then(response => {
                ...
                updateKategori(){
                    if (this.kategori.nama == "" || this.kategori.deskripsi == "" ){
                        this.showWarning("Perhatian","Harap mengisi form!")
                        return;
                    }

                    axios
                        .post(this.baseUrl() + '/api/kategori/update.php',this.kategori)
                        .then(response => {
                            if (response.data.error != null){
                                this.showWarning("Perhatian",response.data.error)
                                return
